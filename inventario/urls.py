...
from .views import  ElementListView, ElementDeleteView, ElementDetailView, listar_ventas_vale, \
...
urlpatterns = [
    ...
    path("elementos/eliminar/<int:element_id>", ElementDeleteView.as_view(), name="elementos_delete"),
    path("elementos/editar/<int:element_id>", edit_elemento, name="elementos_edit"),
    path("elementos/detalles/<int:element_id>", ElementDetailView.as_view(), name="elementos_detail"),
    ...
    path("vales-venta/<int:vale_venta_id>/eliminar/<int:venta_id>", VentasDeleteView.as_view(), name="ventas_delete"),
    path("vales-venta/<int:vale_venta_id>/editar/<int:venta_id>", edit_venta, name="ventas_edit"),
    path("vales-venta/<int:vale_venta_id>/detalles/<int:venta_id>", VentasDetailView.as_view(), name="ventas_details"),

    #urls relativas para las compras
    path("vales-compra/<int:vale_compra_id>/listado-compras", ComprasListView.as_view(), name="compras_list"),
    path("vales-compra/<int:vale_compra_id>/insertar", create_compras, name="create_compras"),
    path("vales-compra/<int:vale_compra_id>/eliminar/<int:compra_id>", ComprasDeleteView.as_view(), name="compras_delete"),
    path("vales-compra/<int:vale_compra_id>/editar/<int:compra_id>", edit_compra, name="compras_edit"),
    path("vales-compra/<int:vale_compra_id>/detalles/<int:compra_id>", ComprasDetailView.as_view(), name="compras_detail"),
